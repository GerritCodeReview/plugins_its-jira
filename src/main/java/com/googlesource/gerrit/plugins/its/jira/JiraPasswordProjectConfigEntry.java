...
class JiraPasswordProjectConfigEntry extends ProjectConfigEntry {
   ...
   * @return encrypted text
   *
   * For now, this method is returning the same parameter it receives as the
   * encryption code was deemed unsuitable to be added to this same plugin.
   *
   * Instead, work to add encrypting capabilities to Gerrit core is in process
   * [1]; once this is completed, this method should be modified to integrate
   * the final encryption implementation.
   *
