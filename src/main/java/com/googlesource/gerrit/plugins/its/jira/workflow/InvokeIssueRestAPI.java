...
public class InvokeIssueRestAPI implements CustomAction {
  ...
  private final InvokeRestAPICommon invokeRestAPICommon;
  ...
  public InvokeIssueRestAPI(
    ...
    this.invokeRestAPICommon = new InvokeRestAPICommon(itsPath, parametersExtractor);
  }
  ...
  public void execute(
    ...
    jiraClient.invokeIssueRestAPI(
        ...
        invokeRestAPICommon.render(parameters, properties));
  }
