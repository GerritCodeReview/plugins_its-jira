...
public class JiraConfig {
  ...
  private static JiraItsServerInfo buildDefaultServerInfo(Config gerritConfig, String pluginName) {
    return JiraItsServerInfo.builder()
        ...
        .visibility(gerritConfig.getEnum(pluginName, null, GERRIT_CONFIG_COMMENT_VISIBILITY_TYPE, JiraVisibilityType.NOTSET),
  ...
  JiraItsServerInfo getServerInfoFor(String projectName) {
    ...
    return JiraItsServerInfo.builder()
        ...
        .visibility(pluginConfig.getEnum(JiraVisibilityType.values(), PROJECT_CONFIG_COMMENT_VISIBILITY_TYPE, JiraVisibilityType.NOTSET),
