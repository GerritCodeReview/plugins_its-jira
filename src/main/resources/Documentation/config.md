...
Multiple Jira server integration
-----------------------
...
This plugin offers the possibility of configuring integration with multiple Jira
...
for the project, the default configuration will be the one defined in *gerrit.config*.
...
The credentials mentioned at the project level, i.e., in the *project.config* file,
 will take precedence over the global credentials mentioned in *gerrit.config*.
 It is important to notice that __the credentials at the project level are stored as
 clear text and will be visible to anyone having access to the project__.  This is a
