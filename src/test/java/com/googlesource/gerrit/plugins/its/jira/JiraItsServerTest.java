...
public class JiraItsServerTest {
  ...
  @Mock private StringEncryptor encrypt;
  ...
  public void createJiraItsServer() {
    jiraServer =
        new JiraItsServer(
            jiraConfig, "its-jira", serverUser, projectCache, repoManager, itsFacade, encrypt);
  ...
  public void testGetServerFromGerrit() throws MalformedURLException {
    URL url = adjustUrlPath(new URL("http:\\www.jira.com"));
